...
%>
	<div class="container">
		...
		<span style="color: red; font-size: 35px"><%= baoLoi %></span>
		<form action="<%=url %>/Khach-Hang" method="post">
			<input type="hidden" name="act" value="dang-ki">
			<div class="row">
				<div class="col-md-6">
					<h3>Tài khoản</h3>
					<div class="mb-3">
			...
			<label class="form-label">Nếu bạn có tài khoản : <a style="color: blue ;text-decoration: none;" href="dangnhap.jsp">ĐĂNG NHẬP</a></label> 
				</div>
			</div>
		</form>
