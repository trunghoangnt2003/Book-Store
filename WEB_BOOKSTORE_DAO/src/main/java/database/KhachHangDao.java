...
public class KhachHangDao {
		...
		try {
			...
			while (rs.next()) {
				...
				KhachHang kh = new KhachHang(maKhacHang, tenDangNhap, matKhau, hoVaTen, gioiTinh, diaChi,
						diaChiNhanHang, diaChiMuaHang, ngaySinh, soDienThoai, email, false);
				ketQua.add(kh);
			}
		...
		try {
			...
			while (rs.next()) {
				...
				ketQua = new KhachHang(maKhacHang, tenDangNhap, matKhau, hoVaTen, gioiTinh, diaChi, diaChiNhanHang,
						diaChiMuaHang, ngaySinh, soDienThoai, email, false);
			}
	...
	public boolean checkExits(String tenDangNhap) {
	...
	public boolean updatePass(KhachHang t) {
		int ketQua = 0;
		try {
			// Bước 1: tạo kết nối đến CSDL
			Connection con = JDBC.getCon();
